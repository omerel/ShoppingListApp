...
*/
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if (res.moveToFirst()){
                tempPassword =  res.getString(res.getColumnIndex("password"));
                if (tempPassword.equals(mPassword))
                    return true;
                else
                    return false;
            }
            // if user not exist register new user
            else{
                 return dbHelper.insertUser(mEmail,mPassword);
            }
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                goToShppingListActivity(mEmail);
            } else {
